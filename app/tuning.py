...
DEVELOPER_PARAMETERS = (
    ...
    TuningParameter("swipe_pose_grace_frames", "Swipes", "Pose grace frames", "Brief three-finger classification dropouts tolerated after the gesture starts.", 2.00, 0.00, 5.00, 1.00, 0),
    ...
    TuningParameter("swipe_axis_dominance", "Swipes", "Axis dominance", "How strongly one direction must lead before horizontal or vertical tracking locks.", 1.15, 1.00, 2.00, 0.05, 2),
